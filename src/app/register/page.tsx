        ...
        <div className="flex items-center p-8 lg:p-12">
          <div className="w-full">
            ...
            <form onSubmit={handleSubmit(() => undefined)} className="mt-8 space-y-5">
              ...
              <label className="group relative block">
                <input {...register('phone')} placeholder=" " className="peer h-14 w-full border-b border-white/20 bg-transparent px-1 text-slate-200 outline-none transition-colors focus:border-[#FF8C00]" />
                <span className="pointer-events-none absolute left-1 top-4 text-sm text-slate-400 transition-all peer-focus:-top-3 peer-focus:text-xs peer-focus:text-amber-400 peer-[&:not(:placeholder-shown)]:-top-3 peer-[&:not(:placeholder-shown)]:text-xs">Phone</span>
                <span className="absolute bottom-0 left-0 h-[2px] w-0 bg-gradient-to-r from-[#FF8C00] to-[#ffc266] transition-all duration-300 peer-focus:w-full" />
              </label>
              <label className="group relative block">
